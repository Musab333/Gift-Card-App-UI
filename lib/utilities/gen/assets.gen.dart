...
class $AssetsCardGen {
  ...
  AssetGenImage get cakeBday => const AssetGenImage('assets/card/1.jpg');

  /// File path: assets/card/doge-xmas.png
  AssetGenImage get dogeXmas => const AssetGenImage('assets/card/2.jpg');

  /// File path: assets/card/flower.png
  AssetGenImage get flower => const AssetGenImage('assets/card/3.jpg');

  /// File path: assets/card/gift-happy.png
  AssetGenImage get giftHappy => const AssetGenImage('assets/card/4.jpg');

  /// File path: assets/card/gift-xmas.png
  AssetGenImage get giftXmas => const AssetGenImage('assets/card/5.jpg');
  ...
  AssetGenImage get hohoho => const AssetGenImage('assets/card/6.jpg');

  /// File path: assets/card/sock-xmas.png
  AssetGenImage get sockXmas => const AssetGenImage('assets/card/7.jpg');
